...
public final class KeyboardUtils {
    ...
    public static void showSoftInput(final Activity activity, final int flags) {
        ...
        showSoftInput(activity,view, flags);
    }
     ...
     *              0 or have the {@link InputMethodManager#SHOW_IMPLICIT} bit set.
     */
    public static void showSoftInput(Context context,final View view, final int flags) {
...
//        window.setSoftInputMode(softInputMode & ~WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
     ...
     * <p>Call the function in  AppCompatActivity#onDestroy().</p>
     *
     * @param activity The activity.
     */
    public static void fixSoftInputLeaks(Context context,final Activity activity) {
